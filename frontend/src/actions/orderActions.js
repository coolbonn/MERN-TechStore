...
export const deleteMyOrder = () => async (dispatch, getState) => {
  try {
    dispatch({ type: DELETE_MY_ORDER_REQUEST })
    ...
    dispatch({
      type: DELETE_MY_ORDER_SUCCESS,
    })
  } catch (error) {
    dispatch({
      type: DELETE_MY_ORDER_FAIL,
      payload:
        error.response && error.response.data.message
          ? error.response.data.message
          : error.message,
...
export const myOauthUserOrderList = () => async (dispatch, getState) => {
  try {
    dispatch({ type: MY_OAUTH_USER_ORDER_LIST_REQUEST })
    ...
    const { data } = await axios.get(`/api/orders/myoauthuserorders`, config)

    dispatch({
      type: MY_OAUTH_USER_ORDER_LIST_SUCCESS,
      payload: data,
    })
  } catch (error) {
    dispatch({
      type: MY_OAUTH_USER_ORDER_LIST_FAIL,
      payload:
        error.response && error.response.data.message
          ? error.response.data.message
          : error.message,
